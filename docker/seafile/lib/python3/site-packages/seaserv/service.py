...
def get_org_groups_by_user(org_id, user, return_ancestors=False):
    """
    Get user's groups in org.
    """
    return ccnet_threaded_rpc.get_org_groups_by_user (user, org_id, 1 if return_ancestors else 0)
